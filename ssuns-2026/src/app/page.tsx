...
export default function HomePage() {
  ...
  return (
    <>
      <section className="page-shell mt-0" id="hero">
        <div className="film-grain section-entrance relative isolate overflow-hidden border border-[#20349c] bg-[#0f183e] px-6 py-12 shadow-[var(--shadow-strong)] sm:px-10 sm:py-16">
          ...
          <div className="relative z-20 grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <LiquidButton
                  className="border-white/40 bg-[rgba(255,255,255,0.1)] text-white hover:border-white hover:bg-white hover:text-[var(--accent)]"
            ...
            <aside className="border border-white/16 bg-[rgba(11,19,56,0.46)] p-5 text-white">
              <p className="section-kicker text-[#b4caff]">{homeContent.editorial.label}</p>
              <h2 className="mt-4 text-3xl font-semibold leading-tight">{homeContent.editorial.title}</h2>
      ...
      <section className="page-shell mt-8">
        ...
        <div className="mt-8 space-y-16">
              ...
              <div className="theme-panel-strong paper-grain rounded-[8px] p-6 sm:p-8">
                <div className="flex flex-wrap items-end justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-3 text-4xl font-semibold leading-tight text-[var(--accent)]">{homeContent.timeline.title}</h2>
                  </div>
          ...
          <section className="grid gap-6 lg:grid-cols-[0.4fr_0.6fr]" id="mission">
            <aside>
            ...
            <div className="space-y-6">
              <article className="theme-panel-strong paper-grain section-entrance p-6 sm:p-8">
              ...
              <article className="theme-panel paper-grain section-entrance overflow-hidden p-5 sm:p-6">
                <p className="section-kicker">{homeContent.directorNote.label}</p>
                <div className="mt-4 grid gap-4 sm:grid-cols-[0.72fr_1.28fr] sm:items-start">
                  <DossierFigure alt={homeContent.directorNote.image.alt} ratio="4/5" src={homeContent.directorNote.image.src} />
                  <div>
                    <h3 className="text-[1.7rem] font-semibold leading-tight text-[var(--accent)]">{homeContent.directorNote.title}</h3>
        ...
        <div className="mx-auto max-w-[96rem]">
          <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 max-w-3xl text-4xl font-semibold leading-tight sm:text-5xl">{homeContent.registrationBand.title}</h2>
            </div>
            <div>

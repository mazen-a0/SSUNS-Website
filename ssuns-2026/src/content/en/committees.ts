...
export const committeesPageContent = {
  ...
  searchPlaceholder: "Search by name, topic, format, or level",
  allOptionLabel: "All",
...
export const committees: Committee[] = [
  ...
  makeCommittee({
    ...
    overview:
      "With over 92 million tonnes of textile waste generated annually, the rapid growth of the fast fashion industry has become a critical factor in global development. The Global Fashion Summit, held yearly in Copenhagen, is a conference that convenes key stakeholders globally to discuss the evolution of the fashion industry. As one of the world’s most resource-intensive industries, fashion faces pressure to address its environmental and social impacts. This Global Fashion Summit committee will explore persistence labour exploitation within fash fashion garment supply chains, the environmental consequences of cotton cultivation and chemical pollution, and the regulatory gaps that allow these practices to prevail. Delegates’ strategies must acknowledge both the social and environmental aspects of the industry, with the goal of these discussions to be strategies encouraging sustainable garment production.",

export const homeContent = {
  ...
  directorNote: {
    ...
    body: [
      ...
      "I view SSUNS as a powerful facilitator which brings together more than 1,400 of the most brilliant young high school, middle school, and CEGEP minds. In addition, I know SSUNS 2026 will be a unique year: one that defines our conference for years to come. The past few iterations of SSUNS have experienced growth and change; this year, my staff and I seek to cement our values based conference into every corner of work we complete and deliver to our Delegations. This year, I am emphasizing success through trust, coordination, and academic excellence when creating our committee content and other delegation services - one that mirrors our responsibilities as students at McGill University.",

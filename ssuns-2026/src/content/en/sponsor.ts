export const sponsorContent = {
  ...
  pastSponsorsTitle: "Past sponsors",
  pastSponsorsPlaceholder:
    "Past sponsor marks and acknowledgements can be added here once the 2026 package is finalized.",
  contactTitle: "Sponsorship contact",
  contactEmail: "sponsorship@ssuns.org",
  fallbackEmail: "info@ssuns.org",
  packageLabel: "Sponsorship package",
  packagePath: "/docs/SSUNS_Sponsorship_Package_2026.pdf",
  packageComingSoon: "Package coming soon",
  cta: {
    label: "Register now",

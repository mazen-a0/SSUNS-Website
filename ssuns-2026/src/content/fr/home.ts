...
export const homeContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { ...en.hero.stats[1], label: "Écoles" },
      { ...en.hero.stats[2], label: "Comités" },
      { ...en.hero.stats[3], label: "Jours" },
    ],
  },
  sectionIndex: [
    { ...en.sectionIndex[0], label: "Vue d'ensemble" },
    { ...en.sectionIndex[1], label: "En bref" },
    { ...en.sectionIndex[2], label: "Mission" },
    { ...en.sectionIndex[3], label: "Comités" },
    { ...en.sectionIndex[4], label: "Lieu" },
    { ...en.sectionIndex[5], label: "Inscription" },
  ],
  atGlance: {
    ...en.atGlance,
    label: "En bref",
    items: [
      {
        ...
        label: "Dates",
        value: "Mars 2026",
        detail: "Quatre journées de conférence avec arrivées échelonnées et cérémonies de clôture.",
      },
      {
        ...en.atGlance.items[1],
        label: "Lieu",
        value: "Sheraton Montréal",
        detail: "Un cadre hôtelier centralisé où comités, soutien aux conseillers et plénières se déroulent sous un même toit.",
      },
      {
        ...en.atGlance.items[2],
        label: "Comités",
        value: "35 programmes",
        detail: "Assemblées générales, salles spécialisées et formats de crise au rythme distinct.",
      },
      {
        ...en.atGlance.items[3],
        label: "Délégations",
        value: "90+ écoles",
        detail: "Écoles canadiennes et internationales, conseillers et leaders étudiants.",
      },
    ],
  },
  editorial: {
  ...
  timeline: {
    ...
    items: [
      ...
      { ...en.timeline.items[3], date: "févr. 2026", label: "Séance d'information pour conseillers et orientation des délégués" },
      { ...en.timeline.items[4], date: "mars 2026", label: "Semaine de la conférence à Montréal" },
    ],
  },
  gallery: {
    ...en.gallery,
